 ...
 * 网贷平台风险评估业务
 */
public class NetLoanServlet extends HttpServlet {
...
doGet(request,response);
    ...
    public void doPage(HttpServletRequest request, HttpServletResponse response)
        ...
        page.setTotalCount(pl.count("NetLoancount"));
//
        // 调用Service层进行分页查询
        pl.RecordsList(page,"NetLoancount");
        ...
        request.getRequestDispatcher("/WEB-INF/pages/netloan.jsp").forward(request, response);
    }
