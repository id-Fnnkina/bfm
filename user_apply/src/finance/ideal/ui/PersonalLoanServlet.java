...
doGet(request,response);
    ...
    public void doPage(HttpServletRequest request, HttpServletResponse response)
        ...
        page.setTotalCount(pl.count("PersonalLoancount"));
//
        // 调用Service层进行分页查询
        pl.RecordsList(page,"PersonalLoancount");
        ...
        request.getRequestDispatcher("/WEB-INF/pages/personalloan.jsp").forward(request, response);
    }
