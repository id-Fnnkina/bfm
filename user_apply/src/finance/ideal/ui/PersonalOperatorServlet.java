 ...
 * 个人运营商信用风险评估业务
 */
public class PersonalOperatorServlet extends HttpServlet {
...
doGet(request,response);
    ...
    public void doPage(HttpServletRequest request, HttpServletResponse response)
        ...
        page.setTotalCount(pl.count("PersonalOperatorcount"));
//
        // 调用Service层进行分页查询
        pl.RecordsList(page,"PersonalOperatorcount");
        ...
        request.getRequestDispatcher("/WEB-INF/pages/personaloperator.jsp").forward(request, response);
    }
