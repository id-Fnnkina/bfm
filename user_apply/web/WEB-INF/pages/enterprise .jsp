...
<div id="base" class="">
        ...
        <div id="g1137" style="top: 350px">
            ...
            <table align = "center" frame="void" rules="all" style="width:80%;border: 1px solid #090607; ">
                ...
                <tr style="height:40px ;background:#f0fff6" ;>
                    ...
                    <th ><%=prettyLoan.getCollisionPercentage()%></th>
                    <th ><%=prettyLoan.getBusinessNameSc()+":"+prettyLoan.getScGetCount()%></th>
                    <th ><%=prettyLoan.getStatus()%></th>
                    <th style="color:#38a8ff">
                        下载：<a href="UploadDownloadServlet?method=downloadfile&methodid=2&id=<%=prettyLoan.getId()%>">导出报表</a>
                ...
                <tr><td class="altbg2" colspan="8" rowspan="2" align="right">
                    <a href="enterprise?action=list&pageIndex=1">首页</a> &#160;&#160;
                    <a href="enterprise?action=list&pageIndex=<%=page1.getPageIndex()-1<1?1:page1.getPageIndex()-1%>">上一页</a>&#160;&#160;
                    &#160;&#160;&#160;第<%=page1.getPageIndex()%>页/共<%=page1.getTotalPageCount()%>页 &#160;&#160;&#160;
                    <a href="enterprise?action=list&pageIndex=<%=page1.getPageIndex()+1>page1.getTotalPageCount()?page1.getPageIndex():page1.getPageIndex()+1%>">下一页</a>&#160;&#160;
                    <a href="enterprise?action=list&pageIndex=<%=page1.getTotalPageCount()%>">末页</a> &#160;&#160;&#160;
    ...
    <div id="u1233" class="ax_default" data-label="个人框" data-left="1158" data-top="77" data-width="147" data-height="36">
        ...
        <div style="position: relative;top: 200px;left: 325px;width: 880px;height: 120px;background: #e0e0e0">
            ...
            <p>
                功能介绍：请按模板格式导入企业经营风险评估信息进行批量风险评估。
            </p></div>
            <div style="position:absolute;top:80px ;left: 10%;width: 20%;height: 35px; "align="center">
                <button><a href="UploadDownloadServlet?method=downenterprisemodel">下载模板</a></button><br>
            </div>
...
<script type="text/javascript">
    ...
    function uploadFile(){
        ...
        var FileController = "FileSelectServlet?modeltype=enterprisecount"; // 接收上传文件的后台地址
        if(fileObj){
            alert("文件正在上传！");
            showdiv('表单数据提交中');
            // FormData 对象
            ...
            xhr.onload = function () {
                alert("文件已上传完成！");
                window.document.location.href="enterprise";
                closediv();
