...
<%
    ...
    String str_leader=request.getParameter("leader");
%>
<div id="base" class="">
    ...
    <div id="u1544" class="ax_default" data-label="金融防控" data-left="237" data-top="80" data-width="1094" data-height="721">
        ...
        <!-- Unnamed (矩形) -->
        <div id="u1583" class="ax_default button">
            <div id="u1583_div" class=""></div>
            <div id="u1583_text" class="text ">
                <p><span><a href="UploadDownloadServlet?method=downloadbusinesslist&id=<%=str_id%>&leader=<%=str_leader%>">导出报表</a></span></p>
            </div>
        </div>
    </div>
    ...
    <div id="u1584" class="ax_default" data-label="管理" data-left="233" data-top="211" data-width="1078" data-height="326">
        ...
        <div id="u1585" class="ax_default">
            ...
            <%
                if (list.size()==0){%>
            <div id="jz">
                <span>你所搜索的公司暂无无信息，敬请期待后续更新。。。</span>
                <br><br><br>
            ...
            <table align = "center" frame="void" rules="all" style="width:100%;border: 1px solid #090607; ">
                ...
                <tr style="height:40px ;background:#949e9f;margin-left: 1px" ;frame=void border-bottom: 1px solid red;>
                    <font size=5><%=str_leader%>业务流水号<%=str_id%>记录</font>
                </tr>
                <tr style="height:50px ;background:#949e9f" ;frame=void border-bottom: 1px solid red;>
                    <th width="60px">业务ID</th>
                    <th width="100px">评估模型类型</th>
                    <th width="80px">业务办理时间</th>
                    <th width="80px">调用数据源</th>
                    <th>成功数据源</th>
                    <th width="60px">备注</th>
                </tr>
                ...
                <%
                        for(int i = list.size()-1;i>=0;i--){
                            BusinessList blist =(BusinessList) list.get(i);
                           %>
                <tr style="height:30px">
                    <th><%=blist.getId()%></th>
                    <th><%=blist.getEvModel()%></th>
                    <th><%=blist.getBusinessTime()%></th>
                    <th><%=blist.getBusinessDataUse()%></th>
                    <th><%=blist.getBusinessDataSuc()%></th>
                    <th style="color:#38a8ff"><a href="./businesslistdetail?id=<%=blist.getId()%>">点击查看</a></th>
                        <% } %>
            </table>
            <br><br><br>
            <button style="width: 150px;height: 35px;background: #26bed6" type="button"><a  href="./workplace">返回</a></button>
