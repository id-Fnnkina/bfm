...
<div id="base" class="">
    ...
    <div id="u1267" class="ax_default" data-label="区块链详情" data-left="386" data-top="80" data-width="591" data-height="863">
        <% ChainCodeDomain chainCodeDomain =(ChainCodeDomain)request.getAttribute("recordid");
        if (null==chainCodeDomain){%>
             <div id="jz">
       ...
       <% }else {%>
        <div id="companylook">
            ...
            <div id="c_id">
                ...
                <div id="c_id_value">
                    <p id="c_id_value_text" align="center">
                        <%=chainCodeDomain.getRecordId()%></p>
                </div>
            </div>
            <!-- 平台名称: -->
            <div id="c_company">
                <div id="c_company_key">
                    <p id="c_company_text" align="right">客户姓名:</p>
                </div>
                <div id="c_company_value">
                    <p id="c_company_value_text" align="center">
                        <%=chainCodeDomain.getRealName()%></p>
                </div>
            </div>

            <div id="c_time">
                <div id="c_time_key">
                    <p id="c_time_key_text" align="right">上链时间:</p>
                </div>
                <div id="c_time_value">
                    <p id="c_time_value_text" align="center">
                        <%=chainCodeDomain.getVerifyDate()%>
                    </p>
                </div>
            </div>
            ...
            <div id="c_place">
                <div id="c_place_key">
                    <p id="c_place_key_text" align="right">银行卡号:</p>
                </div>
                <div id="c_place_value">
                    <p id="c_place_value_text" align="center">
                        <%=chainCodeDomain.getBankCard()%>
                    </p>
                </div>
            </div>
            ...
            <div id="c_term">
                <div id="c_term_key">
                    <p id="c_term_key_text" align="right">结果Hash值:</p>
                </div>
                <div id="c_term_value">
                    <p id="c_term_value_text" align="center">
                        <%=chainCodeDomain.getHashData()%>
                    </p>
                </div>
            </div>
            ...
            <div id="c_average">
                <div id="c_average_key">
                    <p id="c_average_key_text" align="right">手机号:</p>
                </div>
                <div id="c_average_value">
                    <p id="c_average_value_text" align="center">
                        <%=chainCodeDomain.getMobile()%>
                    </p>
                </div>
            </div>
            ...
            <div id="c_score">
                <div id="c_score_key">
                    <p id="c_score_key_text" align="right">业务序列:</p>
                </div>
                <div id="c_score_value">
                    <p id="c_score_value_text" align="center">
                        <%=chainCodeDomain.getBusinessNumber()%>
                    </p>
                </div>
            </div>
            ...
            <div id="c_money">
                <div id="c_money_key">
                    <p id="c_money_key_text" align="right">数据源类型:</p>
                </div>
                <div id="c_money_value">
                    <p id="c_money_value_text" align="center">
                        <%=chainCodeDomain.getSource()%>
                    </p>
                </div>
            </div>
            <!-- 股权上市-->
            <div id="c_equity">
                <div id="c_equity_key">
                    <p id="c_equity_key_text" align="right">身份证号:</p>
                </div>
                <div id="c_equity_value">
                    <p id="c_equity_value_text" align="center">
                        <%=chainCodeDomain.getIdNo()%>
                    </p>
                </div>
            </div>
            <div id="c_use">
                <div id="c_use_key">
                    <p id="c_use_key_text" align="right">使用方:</p>
                </div>
                <div id="c_use_value">
                    <p id="c_use_value_text" align="center">
                        <%=chainCodeDomain.getCompanyName()%>
                    </p>
                </div>
            </div>
            <div id="c_button_chaincode">
                <button style="width: 150px;height: 35px;background: #26bed6" type="button"><a  href="./chaincode">返回</a></button>
            </div>
            <%}%>
