...
<%  Member member = (Member)request.getAttribute("member");
    ...
    System.out.println(member.getBusinessinterface());
    ...
    <div id="background" >
        ...
        <div id="b_role1">
            ...
            <div id="b_title_1_value2">
                ...
                <div id="b_title_1_value2_value2" style="height: 90px ;">
                    <table>
        ...
        <div id="b_role2">
            <div id="b_title_2">
                <div id="b_title_2_name">
                    <p id="b_title_2_name_p" align="right">数据使用方信息：</p>
                </div>
            </div>
            <div id="b_title_2_value1">
                ...
                <div id="b_title_2_value1_value2">
                    <p id="b_title_2_value1_value2_p">
                        <%=member.getBusinessinterface()==null?"请填写接口地址":member.getBusinessinterface()%>
                    </p>
                </div>
            </div>
                ...
                <div id="b_title_2_value2_value2">
                    <table>
                        ...
                        <tr>
                            ...
                            <td><input  type="checkbox" <%=member.getCompanyname().equals(memberNames.get(j))?"checked":""%>><%=memberNames.get(j)%></td>
                            <%}%>
                            <%if (j++<memberNames.size()){%>
                            <td><input  type="checkbox" <%=member.getCompanyname().equals(memberNames.get(j))?"checked":""%>><%=memberNames.get(j)%></td>
                            <%}%>
            ...
            <div id="b_title_2_value3">
                ...
                <div id="b_title_2_value3_value2">
            ...
            <div id="b_title_2_value4">
                <div id="b_title_2_value4_value1">
                    <p id="b_title_2_value4_value1_p" align="right">
                        评估模型选择：
                    </p>
                </div>
                <div id="b_title_2_value4_value2">
                    <table>
                        <%
                            if (0!=modelNames.size()){
                                for (int i = 0; i < modelNames.size(); i=i+2) {
                                    int j = i;
                        %>
                        <tr>
                            <%if (j<modelNames.size()){%>
                            <td><input  type="checkbox" <%=member.getModelSelect().equals(modelNames.get(j))?"checked":""%>><%=modelNames.get(j)%></td>
                            <%}%>
                            <%if (j++<modelNames.size()){%>
                            <td><input  type="checkbox" <%=member.getModelSelect().equals(modelNames.get(j))?"checked":""%>><%=modelNames.get(j)%></td>
                            <%}%>
            ...
            <div id="b_title_1_button" style="top: 103%;  position:absolute;left:30%">
