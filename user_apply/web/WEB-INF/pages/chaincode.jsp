    ...
    <div id="u1065" class="ax_default" data-label="背景" data-left="0" data-top="-8" data-width="1342" data-height="962">
        ...
        <div id="u1067" class="ax_default" data-label="列表" data-left="0" data-top="63" data-width="203" data-height="891">
            ...
            <div id="u1068" class="ax_default shape">
                <div id="u1068_div" style="width: 222px"></div>
            </div>
            <style>
                .loan:hover{
                    background: #26afd6;
        ...
        <div id="u1096" class="ax_default" data-left="213" data-top="136" data-width="1129" data-height="74">
            ...
            <div id="u1226" class="ax_default _标题_1">
                ...
                <div id="u1226_text" class="text ">
                    <p><span>区块链查询管理列表</span></p>
                </div>
            </div>

        </div>
        <div style="position:relative;top: 170px;left: 250px;width: 500px;height: 60px">
            <div id="datachaincode" style="position: absolute;top: 0px;left: 10%;width: 35%;height: 35%;background: #0a6cd6;border: 1px solid #090607">
                <a href="chaincode" >标签碰撞区块链记录</a>
            </div>
            <div id="modelchaincode" style="position: absolute;top: 0px;left: 50%;width: 35%;height: 35%;border: 1px solid #090607">
                <a href="chaincodemodel">模型评估区块链记录</a>
            </div>
        </div>
        <form action="${pageContext.request.contextPath}/chaincode">
            <div style="position: relative;top: 105px;left: 700px;width: 400px;height: 50px;">
    ...
    left: 220px;">
            ...
            <table  align = "center" frame="void" rules="all" style="width:85%;border: 1px solid #090607; ">
                <tr style="height:50px ;background:#949e9f" ;frame=void border-bottom: 1px solid red;>
                    <th width="155px">业务流水号</th>
                    <th width="150px">业务对象(个人/企业/平台)</th>
                    <th width="150px">业务类型</th>
                    <th >业务评估结果</th>
                    <th width="100px">业务申请方</th>
                    <%--<th >业务序列</th>--%>

                    <%--<th width="80px">数据源类型</th>--%>
                    <%--<th >身份证号</th>--%>
                    <%--<th >业务号</th>--%>
                    <th width="40px">备注</th>
                </tr>
                ...
                <%
                    for(int i = 0;i<list.size();i++){
                        ChainCodeDomain chainCode = (ChainCodeDomain) list.get(i);%>
                <tr style="height:40px ;background:#f0fff6" ;>
                    <th><%=chainCode.getBusinessNumber()%></th>
                    <%--<th><%=chainCode.getRecordId()%></th>--%>
                    <th ><%=chainCode.getRealName()%></th>

                    <th ><%=chainCode.getTaskType()==null?"未知类型":chainCode.getTaskType()%></th>
                    <th><%=chainCode.getHashData()%></th>

                    <th><%=chainCode.getCompanyName()%></th>


                    <%--<th ><%=chainCode.getVerifyDate()%></th>--%>
                    <%--<th><%=chainCode.getBankCard()%></th>--%>

                    <%--<th><%=chainCode.getMobile()%></th>--%>

                    <%--<th><%=chainCode.getSource()%></th>--%>
                    <%--<th><%=chainCode.getIdNo()%></th>--%>
                    <%--<th><%=chainCode.getRemark()%></th>--%>
                    <!-- 此处设置了一个修改<a>标签,做修改操作.并将上面拿到的数据传给update.jsp,当进入修改页面的时候,原来的数据会显示 -->
                    <th style="color:#38a8ff"><a href="./chaincodedetail?recordid=<%=chainCode.getRecordId()
                    %>">详情</a> 
        ...
        <!-- Unnamed (矩形) -->
        <div id="u1232" class="ax_default button" style="top: 165px">
            <div id="u1232_div" class=""></div>
            <div id="u1232_text" class="text ">

                <p><span><a href="UploadDownloadServlet?method=downloachaincode&BusinessNumber=<%=businessNumber%>">导出报表</a></span></p>
