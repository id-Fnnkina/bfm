...
<div id="base" class="">
    ...
    <div id="u1267" class="ax_default" data-label="区块链详情" data-left="386" data-top="80" data-width="591" data-height="863">
        <% ChainCodeModelDomain chainCodeModelDomain =(ChainCodeModelDomain)request.getAttribute("recordid");
        if (null==chainCodeModelDomain){%>
             <div id="jz">
       ...
       <% }else {%>
        <div id="companylook">
            ...
            <div id="c_id">
                ...
                <div id="c_id_value">
                    <p id="c_id_value_text" align="center">
                        <%=chainCodeModelDomain.getRecordId()%></p>
                </div>
            </div>
            <!-- 平台名称: -->
            <div id="c_company">
                ...
                <div id="c_company_value">
                    <p id="c_company_value_text" align="center">
                        <%=chainCodeModelDomain.getBusinessNumber()%></p>
                </div>
            </div>

            <div id="c_time">
                <div id="c_time_key">
                    <p id="c_time_key_text" align="right">业务类型:</p>
                </div>
                <div id="c_time_value">
                    <p id="c_time_value_text" align="center">
                        <%=chainCodeModelDomain.getBusinessTypeId()%>
                    </p>
                </div>
            </div>
            ...
            <div id="c_place">
                <div id="c_place_key">
                    <p id="c_place_key_text" align="right">上链时间:</p>
                </div>
                <div id="c_place_value">
                    <p id="c_place_value_text" align="center">
                        <%=chainCodeModelDomain.getEstimateDate()%>
                    </p>
                </div>
            </div>
            ...
            <div id="c_term">
                <div id="c_term_key">
                    <p id="c_term_key_text" align="right">模型id:</p>
                </div>
                <div id="c_term_value">
                    <p id="c_term_value_text" align="center">
                        <%=chainCodeModelDomain.getEstimateModelId()%>
                    </p>
                </div>
            </div>
            ...
            <div id="c_average">
                <div id="c_average_key">
                    <p id="c_average_key_text" align="right">模型类型:</p>
                </div>
                <div id="c_average_value">
                    <p id="c_average_value_text" align="center">
                        <%=chainCodeModelDomain.getEstimateModelType()%>
                    </p>
                </div>
            </div>
            ...
            <div id="c_score">
                <div id="c_score_key">
                    <p id="c_score_key_text" align="right">模型版本:</p>
                </div>
                <div id="c_score_value">
                    <p id="c_score_value_text" align="center">
                        <%=chainCodeModelDomain.getEstimateModelVersion()%>
                    </p>
                </div>
            </div>
            ...
            <div id="c_money">
                <div id="c_money_key">
                    <p id="c_money_key_text" align="right">hash值:</p>
                </div>
                <div id="c_money_value">
                    <p id="c_money_value_text" align="center">
                        <%=chainCodeModelDomain.getHashData()%>
                    </p>
                </div>
            </div>
            <div id="c_button_chaincode">
                <button style="width: 150px;height: 35px;background: #26bed6" type="button"><a  href="./chaincodemodel">返回</a></button>
            </div>
            <%}%>
